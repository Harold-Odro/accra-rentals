  ...
  const loadSearches = () => {
    ...
    if (saved) {
      try {
        ...
        // Silently handle invalid JSON - user likely has no saved searches
        setSearches([])
      }
    }
  }
  ...
  return (
    <>
      <div className="space-y-6">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {searches.map((search, index) => (
            <div
              key={search.id || `${search.location}-${search.savedAt}`}
      ...
      <ConfirmModal
        ...
        message="This will permanently delete all your saved searches. This action cannot be undone."
      ...
      <ConfirmModal
        ...
        confirmLabel="Delete"
        cancelLabel="Cancel"
        onConfirm={() => deleteIndex !== null && deleteSearch(deleteIndex)}
